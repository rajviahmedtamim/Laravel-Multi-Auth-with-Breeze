                      ...
                      <span class="app-brand-logo demo">
                        <svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                              ...
                              <g id="Icon" transform="translate(27.000000, 15.000000)">
                                ...
                                <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
                                  ...
                                  <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
                                    ...
                                    <span class="app-brand-text demo text-body fw-bolder">Fiona</span>
                                </a>
                            </div>
                            <!-- /Logo -->
                            <h4 class="mb-5 text-center">Welcome to Fiona! 👋</h4> @if(Session::has('error')) <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>{{ session::get('error') }}</strong>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div> @endif <form class="mb-3" method="POST" action="{{ route('login') }}"> @csrf <div class="mb-3">
                          ...
                          <i class="bx bx-hide"></i>
                                ...
                                <div class="mb-3">
                                    <button class="btn btn-primary d-grid w-100" type="submit">Sign in me</button>
                                </div>
                            </form>
                            <p class="text-center">
